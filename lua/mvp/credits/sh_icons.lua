...
mvp.credits.AddIcon({name = "v_close", isImage = true}, "Cross", "Freepik - Flaticon", "https://www.flaticon.com/authors/freepik")
-- <a href="https://www.flaticon.com/free-icons/arrow" title="arrow icons">Arrow icons created by Freepik - Flaticon</a>
mvp.credits.AddIcon({name = "v_arrow", isImage = true}, "Arrow", "Freepik - Flaticon", "https://www.flaticon.com/authors/freepik")
-- <a href="https://www.flaticon.com/free-icons/undo" title="undo icons">Undo icons created by Frey Wazza - Flaticon</a>
mvp.credits.AddIcon({name = "v_undo", isImage = true}, "Undo", "Frey Wazza - Flaticon", "https://www.flaticon.com/authors/frey-wazza")
...
mvp.credits.AddIcon({name = "v_link", isImage = true}, "Link", "Creaticca Creative Agency - Flaticon", "https://www.flaticon.com/authors/creaticca-creative-agency")
...
mvp.credits.AddIcon({name = "i_dashboard", isImage = true}, "Dashboard", "Pixel perfect - Flaticon", "https://www.flaticon.com/authors/pixel-perfect")
-- <a href="https://www.flaticon.com/free-icons/cog" title="cog icons">Cog icons created by Freepik - Flaticon</a>
mvp.credits.AddIcon({name = "i_settings", isImage = true}, "Cog", "Freepik - Flaticon", "https://www.flaticon.com/authors/freepik")
...
mvp.credits.AddIcon({name = "i_credits", isImage = true}, "Copyright", "Those Icons - Flaticon", "https://www.flaticon.com/authors/those-icons")
-- <a href="https://www.flaticon.com/free-icons/right" title="right icons">Right icons created by Pixel perfect - Flaticon</a>
mvp.credits.AddIcon({name = "v_check", isImage = true}, "Check", "Pixel perfect - Flaticon", "https://www.flaticon.com/authors/pixel-perfect")
...
mvp.credits.AddIcon({name = "i_permissions", isImage = true}, "Key", "Freepik - Flaticon", "https://www.flaticon.com/authors/freepik")
-- <div> Icons made by <a href="https://www.freepik.com" title="Freepik"> Freepik </a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com'</a></div>
...
mvp.credits.AddIcon({name = "i_packages", isImage = true}, "Package", "sonnycandra - Flaticon", "https://www.flaticon.com/authors/sonnycandra")
-- <a href="https://www.flaticon.com/free-icons/save" title="save icons">Save icons created by Yogi Aprelliyanto - Flaticon</a>
mvp.credits.AddIcon({name = "v_save", isImage = true}, "Save", "Yogi Aprelliyanto - Flaticon", "https://www.flaticon.com/authors/yogi-aprelliyanto")
