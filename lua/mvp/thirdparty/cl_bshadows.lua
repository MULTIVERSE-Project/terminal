...
local function Load()
    ...
    local resolution = scrW .. "x" .. scrH
    
    --The original drawing layer
    BSHADOWS.RenderTarget = GetRenderTarget("bshadows_original" .. resolution, scrW, scrH)
    
    --The shadow layer
    BSHADOWS.RenderTarget2 = GetRenderTarget("bshadows_shadow" .. resolution,  scrW, scrH)
...
hook.Add("OnScreenSizeChanged", "mvp.BSHADOWS.OnScreenSizeChanged", function()
    scrW, scrH = ScrW(), ScrH()
