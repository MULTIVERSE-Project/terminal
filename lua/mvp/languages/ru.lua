...
l["ui.general.open_editor"] = "Открыть редактор"
...
l["menu.terminal.subTitle"] = "Административный интерфейс"

l["menu.terminal.dashboard"] = "Панель управления"
l["menu.terminal.settings"] = "Настройки"
l["menu.terminal.packages"] = "Пакеты"
